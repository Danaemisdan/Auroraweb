...
export const Card = ({
    ...
    return (
        ...
        >
            <div className=" h-full w-full overflow-hidden rounded-2xl bg-zinc-900 flex flex-col items-center justify-center text-white relative">
                ...
                <div className="pt-8 w-full h-full object-cover">
                    {children}
                </div>
            </div>
        </motion.div>
